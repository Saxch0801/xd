...
--
-- Host: localhost    Database: ladesesperanza
-- ------------------------------------------------------
...
INSERT INTO `categorias` VALUES (1,'Pan'),(2,'Bebida'),(3,'Dulce'),(4,'Pastel'),(5,'Galleta'),(6,'Snack'),(7,'Salado');
...
INSERT INTO `productos` VALUES (2,'Cafe de Olla','Cafe de Olla del día',25.00,20,'2024-10-29 11:20:19',2,NULL,'https://www.gastrolabweb.com/u/fotografias/m/2023/8/23/f1280x720-51519_183194_5050.jpg',NULL);
...
CREATE TABLE `productos_proveedores` (
  ...
  CONSTRAINT `productos_proveedores_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`),
...
INSERT INTO `usuarios` VALUES (1,'KON3R','correo@correo.com','Oinotna123','admin','2024-10-29 10:12:01');
...
-- Dump completed on 2024-10-29 11:41:07
